...
def main():
  ...
  filename1 = "pcap/Bitcoin made simple - guardian-2.pcap"
  ...
  percentage_similarity1 = ((avg - diff)/avg)*100

  timearr = []
  for i in range(0, len(arr)):
    timearr.append(i)

  print("Percentage similarity1:", round(percentage_similarity1, 2),"%")
  ...
  percentage_similarity2 = ((avg - diff)/avg)*100

  print("percentage_similarity2: ",percentage_similarity2,"%")

  print("percentage_similarity:", (percentage_similarity1+percentage_similarity2)/2,"%")
