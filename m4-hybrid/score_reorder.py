...
from data_mr import Unpack as UnpackR
from pcap import *
...
dp_r = {} # for storing contents as a dp array for padded files
...
def main(filename, filename_to):
  ...
  print("Comparing ",filename0, filename1, "with reordering")
  ...
  try:
    result1 = dp_r[filename1]
  except:
    result1 = UnpackR(filename1)
    dp_r[filename1] = result1
